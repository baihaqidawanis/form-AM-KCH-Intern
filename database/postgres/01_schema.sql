...
CREATE TABLE IF NOT EXISTS "mesin" (
  ...
  "status_operasional" varchar(20) NOT NULL DEFAULT 'AKTIF',
  "current_deactivation_id" integer NULL,
  PRIMARY KEY ("id")
);
...
CREATE INDEX IF NOT EXISTS "idx_reset_ip_time"
  ON "password_reset_attempts" ("ip_address", "attempt_time");
CREATE INDEX IF NOT EXISTS "idx_reset_ident_time"
  ON "password_reset_attempts" ("identifier_hash", "attempt_time");
...
CREATE TABLE IF NOT EXISTS "master_part" (
  ...
  "active_from" date NOT NULL DEFAULT DATE '2000-01-01',
  "taken_out_at" timestamp NULL,
  "taken_out_by" varchar(255) DEFAULT NULL,
  "takeout_reason" text DEFAULT NULL,
...
-- Histori lifecycle part. Satu part dapat beberapa kali takeout dan reaktivasi.
...
-- Snapshot metadata part per record AM. Master part boleh diubah setelahnya
-- tanpa mengubah label/metode/standard pada laporan yang sudah disubmit.
...
-- Riwayat status operasional mesin (Deaktivasi sementara audit-safe)
...
-- Tanda tangan digital laporan periode AM.
