-- Migration for FBD Jaw Chuan (Compounding)
CREATE TABLE IF NOT EXISTS `fbd_jaw_chuan` (
  `id_fbd_jaw_chuan` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO mesin (nama_mesin) SELECT * FROM (SELECT 'FBD Jaw Chuan' AS nama_mesin) AS tmp WHERE NOT EXISTS (SELECT 1 FROM mesin WHERE nama_mesin = 'FBD Jaw Chuan');
