-- Migration for Mixing Tank (Compounding)
CREATE TABLE IF NOT EXISTS `mixing_tank` (
  `id_mixing_tank` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO mesin (nama_mesin) SELECT * FROM (SELECT 'Mixing Tank' AS nama_mesin) AS tmp WHERE NOT EXISTS (SELECT 1 FROM mesin WHERE nama_mesin = 'Mixing Tank');
