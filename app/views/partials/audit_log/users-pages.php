    ...
    <div class="master-detail-page">
        <div class="card-header p-0 pt-2 px-2">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a data-toggle="tab" href="#audit_log_users_List_<?php echo $page_id ?>" class="nav-link active">
                        List
                    </a>
                </li>
                <li class="nav-item">
                    <a data-toggle="tab" href="#audit_log_users_View_<?php echo $page_id ?>" class="nav-link ">
                        View
                    </a>
                </li>
            </ul>
