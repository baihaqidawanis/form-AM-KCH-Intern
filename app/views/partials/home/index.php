                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    ...
                                    $compounding_machines = array(
                                        ...
                                        array('path' => 'granulator', 'label' => 'Granulator', 'count' => $comp_model->getcount_granulator()),
                                ...
                                <div class="tab-pane fade" id="TabPage-1-Page3" role="tabpanel">
                                    ...
                                    foreach ($kemas_machines as $km) {
                                    ?>
                                    <a class="animated zoomIn record-count card bg-light text-dark"  href="<?php print_link($km['path'] . "/") ?>">
                                        <div class="row">
                                            <div class="col-2">
                                                <i class="fa fa-globe"></i>
                                            </div>
                                            <div class="col-10">
                                                <div class="flex-column justify-content align-center">
                                                    <div class="title"><?php echo $km['label']; ?></div>
                                                    <small class=""></small>
                                                </div>
                                            </div>
                                            <h4 class="value"><strong><?php echo $km['count']; ?></strong></h4>
                                        </div>
                                    </a>
                                    <?php } ?>
                                </div>
                                <div class="tab-pane fade" id="TabPage-1-Page4" role="tabpanel">
                                    ...
                                    foreach ($wrapping_pack_machines as $wm) {
                                    ?>
                                    <a class="animated zoomIn record-count card bg-light text-dark"  href="<?php print_link($wm['path'] . "/") ?>">
                                        <div class="row">
                                            <div class="col-2">
                                                <i class="fa fa-globe"></i>
                                            </div>
                                            <div class="col-10">
                                                <div class="flex-column justify-content align-center">
                                                    <div class="title"><?php echo $wm['label']; ?></div>
                                                    <small class=""></small>
                                                </div>
                                            </div>
                                            <h4 class="value"><strong><?php echo $wm['count']; ?></strong></h4>
                                        </div>
                                    </a>
                                    <?php } ?>
                                </div>
