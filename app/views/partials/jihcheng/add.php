...
$part_details = array(
  ...
  'pocket_pembawa_tube_dan_pack' => array(
  ...
  'shaft_dan_bushing_pusher' => array(
    'metode' => 'Dilumasi',
    'alat' => 'Grease',
    'standard' => 'Terlumasi merata',
    'durasi' => "5'",
    'pelaksanaan' => 'Mingguan (Setiap Selasa Shift 1)'
  ),
  'bearing_rantai_tube_cam_pusher' => array(
    'metode' => 'Dilumasi',
    'alat' => 'Grease',
    'standard' => 'Terlumasi merata',
    'durasi' => "5'",
  ...
  'rantai_penggerak_utama_pocket_tube_pack' => array(
    'metode' => 'Disemprot',
    'alat' => 'Chain Lube',
    'standard' => 'Terlumasi merata',
    'durasi' => "7'",
  ...
  'sensor_tube_pack_nozzle_lem' => array(
    'metode' => 'Tes Fungsi',
    'alat' => 'Visual Control',
  ...
  'pengecekan_tombol_emergency' => array(
    'metode' => 'Tes Fungsi',
    'alat' => 'Visual Control',
    'standard' => 'Buzzer menyala',
    'durasi' => "1'",
    'pelaksanaan' => 'Harian (Setiap Awal Shift 1)'
  )
);
...
$page_element_id = 'jihcheng-add-' . random_str();
?>
<section class="page" id="<?php echo $page_element_id; ?>">
  <div class="bg-light p-3 mb-3">
    <div class="container-fluid">
      <h4 class="record-title">Add Autonomous Maintenance Jihcheng</h4>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="bg-light p-3 animated fadeIn page-content">
          ...
          <form id="jihcheng-add-form" class="form page-form needs-validation" novalidate
            action="<?php print_link("jihcheng/add?csrf_token=$csrf_token") ?>" method="post">
            <input type="hidden" name="mesin" value="34">
            ...
            <div class="text-center"><a class="btn btn-secondary mr-2" href="<?php print_link('jihcheng') ?>">Batal</a><button
