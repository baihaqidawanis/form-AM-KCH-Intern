...
<section class="page" id="<?php echo $page_element_id; ?>">
  <div class="bg-light p-3 mb-3">
    <div class="container-fluid">
      <h4 class="record-title">Edit Data AM Jihcheng</h4>
  ...
  <div class="container-fluid">
    ...
    <div class="bg-light p-3 animated fadeIn page-content">
      ...
      <form id="jihcheng-edit-data-form" class="form page-form needs-validation" novalidate
        action="<?php print_link("jihcheng/edit_data/$rec_id?csrf_token=$csrf_token") ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="text-center">
          <a class="btn btn-secondary mx-1" href="<?php print_link('jihcheng/view/' . $rec_id) ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
