...
$part_details = array(
  'body_mesin' => array(
    ...
    'durasi' => "10'",
    'pelaksanaan' => 'Harian (Setiap akhir Shift 1)'
  ),
  'pressure_gauge' => array(
    'metode' => 'Dicek',
    'alat' => 'Visual Control',
    'standard' => 'Tekanan 5 - 6 bar',
    'durasi' => "1'",
    'pelaksanaan' => 'Harian (Setiap akhir Shift 1)'
  ),
  'timer' => array(
  ...
  'valve_hopper' => array(
    'metode' => 'Dicek',
    'alat' => 'Visual Control',
    'standard' => 'Valve tertutup rapat',
    'durasi' => "1'",
    'pelaksanaan' => 'Harian (Setiap akhir Shift 1)'
  ),
  'discharge_valve' => array(
    'metode' => 'Dicek, kencangkan bila perlu',
    'alat' => 'Visual Control',
    'standard' => 'Klem kencang, tidak ada kebocoran',
    'durasi' => "1'",
    'pelaksanaan' => 'Harian (Setiap akhir Shift 1)'
  )
);
...
$sections = array(
  ...
  'STANDAR PENGECEKAN & PENGENCANGAN (INSPECTION & TIGHTENING)' => array(
    'pressure_gauge', 'timer', 'chopper', 'agitator', 'valve_hopper', 'discharge_valve'
  )
);

$csrf_token = Csrf::$token;
$page_element_id = 'supermixer-add-' . random_str();
?>
<section class="page" id="<?php echo $page_element_id; ?>">
  <div class="bg-light p-3 mb-3">
    <div class="container-fluid">
      <h4 class="record-title">Add Autonomous Maintenance Supermixer</h4>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="bg-light p-3 animated fadeIn page-content">
          ...
          <form id="supermixer-add-form" class="form page-form needs-validation" novalidate
            action="<?php print_link("supermixer/add?csrf_token=$csrf_token") ?>" method="post">
            <input type="hidden" name="mesin" value="44">
            ...
            <?php foreach ($sections as $section_title => $section_fields) { ?>
              <div class="section-block mb-4">
                ...
                <?php foreach ($section_fields as $field) {
                  ...
                  $image_path = 'assets/images/supermixer/supermixer ' . $img_key . '.png';
            ...
            <div class="text-center"><a class="btn btn-secondary mr-2" href="<?php print_link('supermixer') ?>">Batal</a><button
