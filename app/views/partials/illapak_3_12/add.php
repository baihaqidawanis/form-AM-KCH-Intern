...
$part_rows = $master_db->GetModel()->where('machine_key', 'illapak_3_12')->where('taken_out_at', null, 'IS')->orderBy('urutan', 'ASC')->get('master_part');
$part_details = array();
$sections = array();
...
<section class="page" id="<?php echo $page_element_id; ?>">
  <div class="bg-light p-3 mb-3">
    <div class="container-fluid">
      <h4 class="record-title">Add Autonomous Maintenance Ilapak 3 - 12</h4>
      ...
      <div class="col-md-9">
        <div class="bg-light p-3 animated fadeIn page-content">
          ...
          <?php if (!$selected_shift) { ?>
            <div class="card mb-3 shadow-sm border-0">
              <div class="card-body p-4">
                ...
                <form method="get" action="<?php print_link('illapak_3_12/add'); ?>">
          ...
          <form id="illapak_3_12-add-form" class="form page-form needs-validation" novalidate
            action="<?php print_link("illapak_3_12/add?csrf_token=$csrf_token") ?>" method="post" enctype="multipart/form-data">
  ...
  if (empty($visible_fields)) { continue; } ?>
            ...
            <div class="text-center mt-4 mb-4 pt-2 pb-2"><a class="btn btn-secondary mr-3" href="<?php print_link('illapak_3_12') ?>">Batal</a><button
