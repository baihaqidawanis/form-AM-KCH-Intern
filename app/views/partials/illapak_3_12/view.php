...
$id = isset($data['id_illapak_3_12']) ? $data['id_illapak_3_12'] : null;
$csrf_token = Csrf::$token;
$current_page = $this->set_current_page_link();
?>
<section class="page"><div class="bg-light p-3 mb-3"><div class="container-fluid"><h4>View Autonomous Maintenance Illapak 3-12 #<?php echo $id; ?></h4></div></div>
...
<div class="mb-3 d-flex flex-wrap align-items-center">
  ...
  <?php if ($can_approve) { ?>
    <a class="btn btn-sm btn-info has-tooltip mx-1" title="Approve This Record" href="<?php print_link("illapak_3_12/edit/$id"); ?>">
      <i class="fa fa-check-circle"></i> Approval
    </a>
  <?php } ?>
  <?php if ($can_edit) { ?>
    <a class="btn btn-sm btn-warning mx-1" href="<?php print_link("illapak_3_12/edit_data/$id"); ?>">
      <i class="fa fa-edit"></i> Edit Data
    </a>
  <?php } ?>
  <?php if ($can_delete) { ?>
    <a class="btn btn-sm btn-danger record-delete-btn mx-1"
      href="<?php print_link("illapak_3_12/delete/$id/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
