                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="input-group">
                                                                    <input id="ctrl-password"  value="<?php  echo $this->set_field_value('password',""); ?>" type="password" placeholder="Enter Password" maxlength="255"  required="" minlength="8" name="password"  class="form-control  password password-strength" />
