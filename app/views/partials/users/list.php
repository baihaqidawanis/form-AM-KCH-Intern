        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    ...
                    <a href="<?php print_link('users/export_specimen'); ?>" target="_blank" class="btn btn-success btn-sm mt-1 shadow-sm"><i class="fa fa-print mr-1"></i> Export</a>
                </div>
                <div class="col-sm-3 ">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id_user"><a href="<?php print_link("users/view/$data[id_user]") ?>"><?php echo $data['id_user']; ?></a></td>
                                                    <td class="td-nama">
                                                    ...
                                                    <td class="td-area">
                                                        <span  data-value="<?php echo $data['area']; ?>" 
                                                            data-pk="<?php echo $data['id_user'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id_user'])); ?>" 
                                                            data-name="area" 
                                                            data-title="Enter Area" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-user_role_id">
                                                        <span  data-source='<?php print_link('api/json/users_user_role_id_option_list'); ?>' 
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-primary has-tooltip" title="View Record" href="<?php print_link("users/view/$rec_id"); ?>">
                                                        ...
                                                        <a class="btn btn-sm btn-success has-tooltip text-white font-weight-bold" title="Aktivasi Akun" href="<?php print_link('users/activate_password/' . $rec_id . '?csrf_token=' . $csrf_token); ?>" onclick="return confirm('Aktifkan akun ini?');">
                                                            <i class="fa fa-check-circle"></i> Aktivasi
                                                        </a>
                                                        <?php } ?>
                                                        <a class="btn btn-sm btn-warning has-tooltip text-dark font-weight-bold" title="Edit This Record" href="<?php print_link("users/edit/$rec_id"); ?>">
