...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Form Tagging</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="form_tagging-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("form_tagging/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-machine_id"  value="<?php  echo $this->set_field_value('machine_id',""); ?>" type="number" placeholder="Enter Machine Id" step="1"  required="" name="machine_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-area_id"  value="<?php  echo $this->set_field_value('area_id',""); ?>" type="number" placeholder="Enter Area Id" step="1"  required="" name="area_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-line_id"  value="<?php  echo $this->set_field_value('line_id',""); ?>" type="number" placeholder="Enter Line Id" step="1"  required="" name="line_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-abnormality"  value="<?php  echo $this->set_field_value('abnormality',""); ?>" type="number" placeholder="Enter Abnormality" step="1"  required="" name="abnormality"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-kategori_tag" name="kategori_tag"  placeholder="Select a value ..."    class="custom-select" >
                                                                    ...
                                                                    $selected = $this->set_field_selected('kategori_tag',$value, "");
                                                                    ?>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-korelasi_tag" data-load-select-options="kategori_ketidaksesuaian" name="korelasi_tag"  placeholder="Select a value ..."    class="custom-select" >
                                                                    ...
                                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                    $selected = $this->set_field_selected('korelasi_tag',$value, "");
                                                                    ?>
                                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                                        <?php echo $label; ?>
                                                                    </option>
