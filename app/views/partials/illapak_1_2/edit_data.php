...
$sections = array(
  ...
  'STANDAR PENGECEKAN & PENGENCANGAN (INSPECTION & TIGHTENING)' => array(
    'position_indicator_sealing_vertical', 'vacum_sliter', 'piston_pengisian',
...
<section class="page" id="<?php echo $page_element_id; ?>">
  ...
  <div class="container-fluid">
    ...
    <div class="bg-light p-3 animated fadeIn page-content">
      ...
      <form id="illapak_1_2-edit-data-form" class="form page-form needs-validation"
        action="<?php print_link("illapak_1_2/edit_data/$rec_id?csrf_token=$csrf_token") ?>" method="post">
        <?php foreach ($sections as $section_title => $section_fields) { ?>
          <div class="section-block mb-4">
            ...
            <?php foreach ($section_fields as $field) {
              ...
              $image_path = 'assets/images/illapak_1_2/illapak_1_2 ' . $img_key . '.png';
            ?>
        ...
        <div class="text-center">
          <a class="btn btn-secondary mx-1" href="<?php print_link('illapak_1_2/view/' . $rec_id) ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
