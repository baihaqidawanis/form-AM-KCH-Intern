...
$data = $this->view_data;
$parts = $data['parts'];
// Foto & pengelompokan section dari master_part
...
$page_element_id = 'granulator-edit-data-' . random_str();
$rec_id = !empty($data['id_granulator']) ? $data['id_granulator'] : null;
?>
<section class="page" id="<?php echo $page_element_id; ?>">
  <div class="bg-light p-3 mb-3">
    <div class="container-fluid">
      <h4 class="record-title">Edit Data AM Granulator</h4>
      <div>Compounding Area</div>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="bg-light p-3 animated fadeIn page-content">
      ...
      <form id="granulator-edit-data-form" class="form page-form needs-validation" novalidate
        action="<?php print_link("granulator/edit_data/$rec_id?csrf_token=$csrf_token") ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="text-center">
          <a class="btn btn-secondary mx-1" href="<?php print_link('granulator/view/' . $rec_id) ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
