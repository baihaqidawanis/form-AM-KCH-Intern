...
<section class="page" id="<?php echo $page_element_id; ?>">
  ...
  <div class="container-fluid">
    ...
    <div class="bg-light p-3 animated fadeIn page-content">
      ...
      <form id="storage_tank-edit-data-form" class="form page-form needs-validation" novalidate
        action="<?php print_link("storage_tank/edit_data/$rec_id?csrf_token=$csrf_token") ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="text-center">
          <a class="btn btn-secondary mx-1" href="<?php print_link('storage_tank/view/' . $rec_id) ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
