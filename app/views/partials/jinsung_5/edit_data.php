...
<section class="page" id="<?php echo $page_element_id; ?>">
  ...
  <div class="container-fluid">
    ...
    <div class="bg-light p-3 animated fadeIn page-content">
      ...
      <form id="jinsung_5-edit-data-form" class="form page-form needs-validation" novalidate
        action="<?php print_link("jinsung_5/edit_data/$rec_id?csrf_token=$csrf_token") ?>" method="post">
        <?php foreach ($sections as $section_title => $section_fields) { ?>
          <div class="section-block mb-4">
            ...
            <?php foreach ($section_fields as $field) {
              ...
              $image_path = 'assets/images/jinsung_5/jinsung_5 ' . $img_key . '.png';
            ?>
        ...
        <div class="text-center">
          <a class="btn btn-secondary mx-1" href="<?php print_link('jinsung_5/view/' . $rec_id) ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
