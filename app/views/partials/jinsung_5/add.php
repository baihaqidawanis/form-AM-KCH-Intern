...
$image_names = array(
  ...
  'shaft_bushing_pusher_piston' => 'shaft bushing pusher piston',
  'rantai_penggerak_utama_cartoning' => 'rantai penggerak utama cartoning',
  'regulator_angin_conveyor_cartoning_check_weigher' => 'regulator angin conveyor cartoning check weigher',
...
$part_details = array(
  'belt_conveyor_dan_pusher_pack' => array(
    'metode' => 'Dilap',
    'alat' => 'Kuas/Quiltec dan Air',
  ...
  'rantai_penggerak_utama_cartoning' => array(
    'metode' => 'Dilumasi',
    'alat' => 'Grease',
    'standard' => 'Terlumasi merata',
    'durasi' => "5'",
  ...
  'regulator_angin_conveyor_cartoning_check_weigher' => array(
    'metode' => 'Dicek',
    'alat' => 'Visual Control',
  ...
  'timing_belt_conveyor' => array(
    'metode' => 'Dicek',
    'alat' => 'Visual Control',
    'standard' => 'Tidak rusak',
    'durasi' => "1'",
    'pelaksanaan' => 'Harian (Setiap Awal Shift 1)'
  )
);
...
$sections = array(
  'STANDAR PEMBERSIHAN (CLEANING)' => array(
    'belt_conveyor_dan_pusher_pack', 'pocket_pembawa_sachet'
  ),
  'STANDAR PELUMASAN (LUBRICATING)' => array(
    'shaft_bushing_pusher_piston', 'rantai_penggerak_utama_cartoning'
  ),
  'STANDAR PENGECEKAN & PENGENCANGAN (INSPECTION & TIGHTENING)' => array(
    'regulator_angin_conveyor_cartoning_check_weigher', 'regulator_angin_chamber_hot_melt', 'sensor_sachet_pack_nozzle', 'timing_belt_conveyor'
  )
);

$csrf_token = Csrf::$token;
$page_element_id = 'jinsung_5-add-' . random_str();
?>
<section class="page" id="<?php echo $page_element_id; ?>">
  <div class="bg-light p-3 mb-3">
    <div class="container-fluid">
      <h4 class="record-title">Add Autonomous Maintenance Jinsung 5</h4>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="bg-light p-3 animated fadeIn page-content">
          ...
          <form id="jinsung_5-add-form" class="form page-form needs-validation" novalidate
            action="<?php print_link("jinsung_5/add?csrf_token=$csrf_token") ?>" method="post">
            <input type="hidden" name="mesin" value="40">
            ...
            <?php foreach ($sections as $section_title => $section_fields) { ?>
              <div class="section-block mb-4">
                ...
                <?php foreach ($section_fields as $field) {
                  ...
                  $image_path = 'assets/images/jinsung_5/jinsung 5 ' . $img_key . '.png';
            ...
            <div class="text-center"><a class="btn btn-secondary mr-2" href="<?php print_link('jinsung_5') ?>">Batal</a><button
