...
$page_element_id = 'best_pack-edit-data-' . random_str();
    ...
    <div class="bg-light p-3 animated fadeIn page-content">
      ...
      <form id="best_pack-edit-data-form" class="form page-form needs-validation" novalidate
        ...
        <div class="text-center">
          <a class="btn btn-secondary mx-1" href="<?php print_link('best_pack/view/' . $rec_id) ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
