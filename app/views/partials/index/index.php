        ...
        <div class="am-login-card">
            ...
            <div class="am-login-form-side">
                <div class="am-form-inner">
                    ...
                    <div class="am-brand-header">
                        ...
                        <p class="am-login-desc">Autonomous Maintenance Management System. Silakan masuk dengan NIK Anda.</p>
                    </div>
                    ...
                    <!-- Login Form -->
                    <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post" autocomplete="on">
                        ...
                        <div class="form-group am-field-group">
                            ...
                            <div class="input-group am-input-wrapper">
                                <div class="input-group-prepend">
                                    <span class="input-group-text am-input-icon"><i class="fa fa-user-circle-o"></i></span>
                                </div>
                                <input id="input-username" placeholder="Masukkan NIK Anda" name="username" required="required" class="form-control am-input-control" type="text" autocomplete="username" />
                            </div>
                        </div>
                        ...
                        <div class="form-group am-field-group">
                            ...
                            <div class="input-group am-input-wrapper">
                                ...
                                <input id="input-password" placeholder="Masukkan Password" required="required" v-model="user.password" name="password" class="form-control am-input-control" type="password" autocomplete="current-password" />
                                <div class="input-group-append cursor-pointer btn-toggle-password" title="Lihat / Sembunyikan Password">
                                    <span class="input-group-text am-input-icon am-toggle-icon"><i class="fa fa-eye"></i></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="am-login-visual-side">
                <div class="am-visual-slideshow">
                    <div class="am-slide-item active" style="background-image: url('<?php print_link('assets/images/bg1.jpeg'); ?>');"></div>
                    <div class="am-slide-item" style="background-image: url('<?php print_link('assets/images/bg2.jpeg'); ?>');"></div>
                    <div class="am-slide-item" style="background-image: url('<?php print_link('assets/images/bg3.jpeg'); ?>');"></div>
